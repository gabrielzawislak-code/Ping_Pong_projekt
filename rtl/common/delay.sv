 ...
 *
 * Description:
 * Delays the input data 'din' by the number of clock cycles set by the
 * CLK_DEL parameter, used to keep VGA timing/rgb signals aligned with the
 * pipeline latency of the drawing stage that reads them.
 */
