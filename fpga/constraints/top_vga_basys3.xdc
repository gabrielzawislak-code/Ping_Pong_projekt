...
## Switches
## Role-select switch: 0 = HOST / Player 1, 1 = CLIENT / Player 2
set_property PACKAGE_PIN V17 [get_ports sw_role]
	set_property IOSTANDARD LVCMOS33 [get_ports sw_role]
...
## LEDs
## DEBUG: led[3:0] = receive_state_frame FSM state, led[4] = frame-ever-OK latch
